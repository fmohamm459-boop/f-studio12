      ...
      <main role="main" className="flex-1">
        ...
        <section className="bg-surface px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 sm:grid-cols-2">
            <StatWidget label={dict.portfolio.totalProjects} value={String(PROJECTS.length)} />
            <StatWidget label={dict.portfolio.clientSatisfaction} value="98%" />
          </div>
        </section>
      </main>
